<?php
    ...
    $privileges_page = 'c6bffa31-a8fc-475b-ac29-8babaeff55f1';
...
<html lang="ru">
    <head>
        ...
        <title>ЕОС - Настройка разрешений исполнения</title>
    </head>
    <body>
        ...
        <main>
            <div class="form-container">
                <h1 class="main-header"> <span class="privileges-icon"></span> Настройка разрешений исполнения</h1>
                <div class="button-bar">
                    <div class="button-group">
                        <button id="ViewAllPrivileges">Просмотреть все разрешения</button>
                        <button id="VievPrivileges" disabled>Просмотреть разрешения пользователя</button>

                        <?php 
                            $privileges_button = '93ce93cb-1caa-4d24-83d6-bbcce1e550e6';
                            if (checkPrivilege( $privileges_button)): ?>
                            <button id="AssignPrivileges" disabled>Назначить разрешения пользователю</button>
                            <button id="OffPrivileges" disabled>Снять разрешения у пользователя</button>
                        <?php endif; ?>

                        <?php 
                            $privileges_button = 'bd711645-54e8-4180-88c1-972a4ebe60e3';
                            if (checkPrivilege( $privileges_button)): ?>
                            <button id="CreatePrivileges">Создать разрешения</button>
                            <button id="DeletePrivileges">Удалить разрешения</button>
                        <?php endif; ?>
